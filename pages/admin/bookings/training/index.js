...
import TrainingBookingTable from "@/components/bookings/trainingtable";
...
import NewTrainingDrawer from "@/components/drawers/newbooking/training";
...
//    }, [filter]);
   ...
   const BookingtypestatusHandler = (status)=>{
    ...
    return(
        ...
        {!loading &&  (
             <TrainingBookingTable data = {borbookings} selectedItems={selectedItems} setSelectedItems = {setSelectedItems}/>
        )
    }
