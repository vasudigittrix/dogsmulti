...
import NewWalkingDrawer from "@/components/drawers/newbooking/walking";
import { Pagination } from "@mui/material";

export default function WalkingBookingPage(){
...
//    }, [filter]);
   ...
   const BookingtypestatusHandler = (status)=>{
    ...
    return(
        ...
        {!loading &&  (
             <WalkBookingTable data = {borbookings} selectedItems={selectedItems} setSelectedItems = {setSelectedItems}/>
        )
    }
        <NewWalkingDrawer
        open = {isModalOpen}
