...
import VetBookingTable from "@/components/bookings/vetbookingtable";
import WalkBookingTable from "@/components/bookings/walkingbooktable";
...
import DayCareBookingTable from "@/components/bookings/daycarebooktable";
import NewDaycareDrawer from "@/components/drawers/newbooking/daycare";
import { Pagination } from "@mui/material";
export default function DayCareBookingPage(){
...
//    }, [filter]);
   ...
   const BookingtypestatusHandler = (status)=>{
    ...
    return(
        ...
        {!loading &&  (
             <DayCareBookingTable data = {borbookings} selectedItems={selectedItems} setSelectedItems = {setSelectedItems}/>
        )
    }
          <NewDaycareDrawer
        open = {isModalOpen}
