...
import OrderEarningTable from "@/components/employees/orderearningtable";
export default function OrderEarnings() {
    ...
    return(
        ...
        />
        {!loading && 
         <OrderEarningTable selectedItems={selectedItems} setSelectedItems = {setSelectedItems} data = {employee}/>
        }
       {/* <Pagination
