...
import { deleteShipzone } from '@/reducer/ShipzoneSlice';
import EditTaxDrawer from '../drawers/edittaxdrawer';
export default function ShippingTable({data, selectedItems, setSelectedItems}){
  ...
  const handledeleteszone =  (id) => {
  dispatch(deleteShipzone([id]))
  }
...
const handleSelectAllChange = () => {
    ...
    return(
        <>
            <DashboardCard title="Shipping Zone">
        ...
        <DeleteCommonModal
            ...
            deleteHandler = {handledeleteszone}
            id = {idtodel}
            />
         <EditTaxDrawer  
         open={edittagopen}
