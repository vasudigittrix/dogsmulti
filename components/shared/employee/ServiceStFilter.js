...
//     />
//   ))
export default function ServiceStatusFilter( {addcategoryHandler, selectedItems , handleApply, filterhandler}) {
...
{selectedValue === 'Status' && (
  <FormControl>
      ...
      <Select
        ...
        >
          <MenuItem value="Addedbyuser">Added by user</MenuItem>
          <MenuItem value="Addedbyadmin">Assign by Admin</MenuItem>
        </Select>
      <Select
            labelId="demo-simple-select-label"
            id="demo-simple-select"
