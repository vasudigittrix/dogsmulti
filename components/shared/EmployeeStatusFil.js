...
import { getEmployeeByTypeComm } from '@/reducer/EmployeeByTypeCoSlice';
...
//     />
//   ))
export default function EmployeeFilter( { selectedItems ,searchHandler, commissionHandler, type, title}) {
