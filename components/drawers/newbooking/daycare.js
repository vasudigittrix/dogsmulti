...
import NewGroomingBookingForm from '@/components/bookings/newgroomingform';
import NewDayCareForm from '@/components/bookings/newdaycareform';
export default function NewDaycareDrawer({open , onClose}){
