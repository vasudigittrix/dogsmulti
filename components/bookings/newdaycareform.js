...
export default function NewDayCareForm({id , onBookingClose, setSelectedCustomer}){
    ...
    const validationSchema = Yup.object().shape({
      ...
      const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
          console.log(values);
          dispatch(createBookingByType({type: 'daycare' ,customerid: id, ...values}));
          resetForm(); 
          onBookingClose();
    ...
    <Grid container direction="column" className="user-block bg-white p-3 rounded">
      ...
      <FormControl fullWidth>
        ...
        >
          ...
          <Grid item xs={12}>
      <FormControl fullWidth>
          <InputLabel>DayCare Taker</InputLabel>
         <Select 
          name="employeeid"
          onChange={formik.handleChange}
...
<InputLabel htmlFor="pickuptime">Pick-up Time</InputLabel>
      ...
      <Grid item xs={6}>
        ...
        label="Favorite Activity"
         ...
         error={formik.touched.favoriteActivity && Boolean(formik.errors.favoriteActivity)}
         helperText={formik.touched.favoriteActivity && formik.errors.favoriteActivity}
         onBlur={formik.handleBlur}  />
      </Grid>
      <Grid item xs={6}>
        <TextField 
        label="Favorite Food"
         ...
         error={formik.touched.favoriteFood && Boolean(formik.errors.favoriteFood)}
         helperText={formik.touched.favoriteFood && formik.errors.favoriteFood}
         onBlur={formik.handleBlur}  />
      </Grid>
          <Grid item xs={6}>
