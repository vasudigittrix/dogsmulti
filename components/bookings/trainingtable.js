...
export default function TrainingBookingTable({data , selectedItems, setSelectedItems}){
    ...
    return(
        <>
          <DashboardCard title="Training Bookings">
